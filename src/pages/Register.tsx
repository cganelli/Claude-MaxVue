...
const Register = () => {
  ...
  const [errorState, setErrorState] = useState<"userExists" | "unknown" | null>(
    null,
  );
  const { register } = useAuth();
  // useNavigate hook available but not used in current implementation
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        console.log(
          "✅ Registration successful, navigation will be handled by routing logic",
        );
      ...
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center">
          <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <Link
              to="/privacy"
              className="text-dark-blue-900 underline hover:text-vivid-blue-500"
            >
              Privacy Policy
            </Link>{" "}
            and{" "}
        ...
        <div className="text-center">
          <p className="text-gray-900 text-lg">
            ...
            <Link
              to="/login"
              className="font-semibold text-dark-blue-900 underline hover:text-vivid-blue-500"
            >
              Log in
            </Link>
          </p>
