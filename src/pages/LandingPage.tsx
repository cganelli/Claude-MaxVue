...
const LandingPage = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "Instantly transform your screen clarity for email, web, photos, and apps",
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      title: "Secure Sync",
      description:
        "Your prescription data syncs securely across all your devices",
    },
  ];
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "The voice activation is incredible. I can toggle vision correction while coding without breaking my flow.",
      rating: 5,
    },
    {
      name: "Emily Johnson",
      role: "Teacher",
      content:
        "MaxVue makes grading papers on my tablet so much easier. The clarity is perfect for my presbyopia.",
      rating: 5,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link
                to="/register"
                className="bg-[#3399FF] text-white px-6 py-2 rounded-lg hover:bg-[#1D4262] transition-colors"
              >
                Get Started
              </Link>
            </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
              With one tap, your phone becomes crystal clear—email, web, photos,
              and apps—all auto-adjusted to your unique vision. No glasses. No
              squinting. Just clear vision.
            </p>
                ...
                <div className="bg-gradient-to-br from-[#3399FF] to-[#1D4262] rounded-xl h-80 flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <p className="text-blue-100">
                      Your screen, perfectly adjusted
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="text-4xl font-bold text-[#3399FF] mb-2">
                  {stat.number}
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-700">
                    Personalized Rx correction via eye test or manual input
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-500 mt-1" />
                  <span className="text-gray-700">
                    Clearer viewing for email, apps, web, photos, and live
                    camera
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                ...
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-500 mt-1" />
                  <span className="text-gray-700">
                    Voice-enabled activation via ElevenLabs
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-500 mt-1" />
                  <span className="text-gray-700">
                    Secure Rx sync across devices using Supabase
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-gray-700 leading-relaxed">
                62% of people need reading glasses. Yet no phone truly adapts to
                the way we see—until now. MaxVue is built for a screen-first
                world. No more misplacing your glasses or enlarging text just to
                read a message. This is digital eyewear, made possible by
                software.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
              ...
              <p className="text-gray-600">
                Secure, real-time Rx profile storage with enterprise-grade
                encryption
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
              ...
              <p className="text-gray-600">
                Natural voice test instructions and hands-free toggles
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center">
              ...
              <p className="text-gray-600">
                Seamless subscription access to Pro features
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#1e1e1e] mb-6">
              See MaxVue in Action
            </h2>
            <p className="text-xl text-gray-600">
              Watch how MaxVue transforms your digital experience
            </p>
          </div>
      ...
      <section id="pricing" className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              MaxVue offers a <strong>FREE Basic plan</strong> and a{" "}
              <strong>Pro plan</strong> with premium features. Subscribe
              monthly, annually, or purchase lifetime access.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border-2 border-gray-200">
              ...
              <div className="text-4xl font-bold text-[#1e1e1e] mb-6">
            ...
            <div className="bg-[#3399FF] rounded-2xl p-8 border-2 border-[#3399FF] relative">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="bg-[#1D4262] text-white px-4 py-2 rounded-full text-sm font-semibold">
                  Most Popular
                </span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">Pro</h3>
              <div className="text-4xl font-bold text-white mb-6">
                $4.99<span className="text-lg text-blue-100">/month</span>
              </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-8">
            *MaxVue Pro is available as an in-app purchase. See our{" "}
            <Link
              to="/faq"
              className="text-[#3399FF] underline hover:text-[#1D4262]"
            >
              FAQ
            </Link>{" "}
            for details.*
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Digital vision correction for the modern world. See clearly
                without glasses.
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400">
              ...
              <a
                href="https://bolt.new"
                className="text-[#3399FF] hover:text-blue-300 transition-colors"
              >
                Bolt.new
              </a>
            </p>
