  ...
  const faqs = [
    {
      ...
      answer:
        "MaxVue is a digital vision support app that helps you see clearly by applying custom visual filters based on your personal prescription or in-app eye test.",
    },
    {
      question: "How does MaxVue improve my vision?",
      answer:
        "MaxVue applies dynamic screen filters tailored to your eyes. Think of it like adjusting contrast and sharpness — but based on your real prescription.",
    },
    {
      question: "Can this replace a visit to the eye doctor?",
      answer:
        "No. MaxVue is not a substitute for a comprehensive eye exam. It's a tool to help you see more clearly in digital environments.",
    },
    {
      question: "What vision conditions does MaxVue support?",
      answer:
        "Myopia, hyperopia, astigmatism, and presbyopia. More filters may be added in future updates.",
    },
    {
      question: "Is MaxVue safe for people with astigmatism?",
      answer:
        "Yes — MaxVue includes filters designed to support astigmatism. Stop using if discomfort occurs and consult an eye care provider.",
    },
    {
      question: "How accurate is the MaxVue eye test?",
      answer:
        "It uses subjective blur calibration designed to optimize your screen — not for medical diagnosis.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Use the in-app eye test to calibrate your vision based on what looks clearest to you.",
    },
    {
      question: "How is my vision data used?",
      answer:
        "It is used only to personalize your experience. We do not sell or share your data.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, it includes optional integrations to apply clarity filters to your emails.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, MaxVue auto-adjusts brightness and contrast using your light sensor.",
    },
    {
      question: "Is my prescription data secure?",
      answer:
        "Yes, stored securely with encryption and row-level access control.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "MaxVue offers a FREE Basic plan and a Pro plan with premium features. You can subscribe to the Pro plan monthly ($4.99/month), annually ($39.99/year), or as a lifetime purchase ($99.99).",
    },
    {
      question: "How do I cancel my subscription?",
      answer:
        "Through your app store account or the web dashboard. Access continues until the current period ends.",
    },
    {
      question: "Can I get a refund?",
      answer:
        "Refunds aren't automatic, but reach out to contact@maxvue.app if there's a problem.",
    },
    {
      question: "What happens if my payment fails?",
      answer:
        "Your subscription will pause and premium features will be disabled until billing info is updated.",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Everything you need to know about MaxVue
          </p>
        </div>
