        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 leading-relaxed mb-8">
              MaxVue respects your privacy and is committed to protecting your
              ...
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-700">
                      {" "}
                      First name, last name, and email address for account
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-700">
                      {" "}
                      Prescription information and eye test results (optional,
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-700">
                      {" "}
                      App usage patterns and preferences to improve your
                      experience.
                    </span>
                  </div>
                </li>
            ...
            <div className="bg-blue-50 rounded-xl p-6 mb-8">
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-[#3399FF] rounded-full mt-2"></div>
                  <span className="text-gray-700">
                    <strong>Personalization:</strong> To provide customized
                    vision correction services tailored to your needs.
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-[#3399FF] rounded-full mt-2"></div>
                  <span className="text-gray-700">
                    <strong>Synchronization:</strong> To sync your settings and
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-700">
                    ...
                    about your account and the service.
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-[#3399FF] rounded-full mt-2"></div>
                  <span className="text-gray-700">
                    <strong>Improvement:</strong> To enhance our app features
                    and user experience.
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-red-50 rounded-xl p-6 mb-8">
              <p className="text-gray-700 leading-relaxed">
                ...
                Your vision data and personal information remain private and are
                used solely to provide and improve our services to you.
              </p>
            </div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-700">
                    ...
                    associated data from the Settings screen.
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-purple-600 rounded-full mt-2"></div>
            ...
            <p className="text-gray-700 leading-relaxed mb-8">
              MaxVue uses minimal cookies and tracking technologies solely for
              essential app functionality and user authentication. We do not use
            ...
            <p className="text-gray-700 leading-relaxed mb-8">
              MaxVue is not intended for children under 13 years of age. We do
            ...
            <p className="text-gray-700 leading-relaxed mb-8">
              ...
              of MaxVue after any changes constitutes acceptance of the new
              policy.
            </p>
            ...
            <div className="bg-[#3399FF] rounded-xl p-6 text-white">
              ...
              <div className="space-y-2">
                <p>
                  <strong>Email:</strong>{" "}
                  <a
                    href="mailto:privacy@maxvue.app"
