      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover how VividVue has transformed the lives of thousands of patients 
            with our expert care and advanced vision correction solutions.
          </p>
        </div>
            ...
            <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="bg-blue-50 rounded-lg p-4 mb-6">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-semibold text-blue-900">Result: {testimonial.result}</span>
                </div>
              </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-blue-600 text-white rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="mb-6 text-blue-100">
              Experience the VividVue difference with personalized care and exceptional results.
            </p>
