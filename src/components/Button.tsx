...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      "bg-vivid-blue-500 text-white hover:bg-dark-blue-900 active:bg-dark-blue-900",
    secondary: "bg-gray-100 text-gray-700 hover:bg-gray-200 active:bg-gray-200",
    outline:
      "border-2 border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-dark-blue-900 active:bg-gray-50",
  };
