      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            For over 25 years, VividVue has been at the forefront of vision correction technology, 
            helping patients achieve perfect sight with compassionate care and cutting-edge treatments.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Latest FDA-approved equipment and surgical techniques for optimal results.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-3"></div>
                <div>
                  ...
                  <p className="text-gray-600">Board-certified specialists with extensive experience in vision correction.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-3"></div>
                <div>
                  ...
                  <p className="text-gray-600">Customized treatment plans tailored to your unique vision needs and lifestyle.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-3"></div>
                <div>
                  ...
                  <p className="text-gray-600">Comprehensive aftercare and lifetime vision guarantee for peace of mind.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h4 className="text-xl font-bold text-gray-900 mb-4">Our Accreditations</h4>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <Award className="h-5 w-5 text-blue-600" />
                  <span className="text-gray-700">American Academy of Ophthalmology</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Award className="h-5 w-5 text-blue-600" />
                ...
                <div className="flex items-center space-x-3">
                  <Award className="h-5 w-5 text-blue-600" />
                  <span className="text-gray-700">FDA Center of Excellence</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Award className="h-5 w-5 text-blue-600" />
                  <span className="text-gray-700">Better Business Bureau A+</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Board-certified specialists dedicated to your vision health</p>
        </div>
