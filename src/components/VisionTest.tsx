      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Take our preliminary vision test to get an initial assessment of your eyesight. 
            Note: This is not a substitute for a comprehensive eye exam.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            {!isTestActive ? (
              <div className="text-center space-y-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Ready to Test Your Vision?</h3>
                <p className="text-gray-600">
                  Sit about 3 feet from your screen in good lighting. Cover one eye and read the chart.
                </p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-yellow-700 text-sm">
                        This screening is for informational purposes only and cannot replace a comprehensive eye examination by a qualified eye care professional.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                ...
                <p className="text-gray-600 text-center">{tests[currentTest].description}</p>
                ...
                {currentTest === 0 && (
                  <div className="bg-white border-2 border-gray-200 rounded-lg p-8 text-center space-y-4">
                    {tests[currentTest].lines.map((line, index) => (
                      <div key={index} className={`${line.size} font-mono font-bold text-gray-900 tracking-wider`}>
                        {line.letters}
                      </div>
                    ))}
                  </div>
                    ...
                    {tests[currentTest].circles?.map((circle, index) => (
                      <div key={index} className="text-center">
                        <div className="w-32 h-32 rounded-full mx-auto mb-4 relative overflow-hidden border-4 border-gray-300">
                          <div className={`absolute inset-0 ${circle.colors[0]} opacity-60`}></div>
                          <div className={`absolute inset-4 ${circle.colors[1]} opacity-80 rounded-full`}></div>
                ...
                <div className="text-center space-y-4">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    <h4 className="font-semibold text-blue-900 mb-2">Ready for a Professional Exam?</h4>
                    <p className="text-blue-700 mb-4">
                      Schedule a comprehensive eye examination for accurate diagnosis and personalized treatment options.
                    </p>
